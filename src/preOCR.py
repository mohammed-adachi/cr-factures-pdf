...
class OCRProcessor:
    def __init__(self, dpi=300, lang="en"):
        ...
        self.ocr = PaddleOCR(
            ...
            # --- MODIFICATIONS ICI ---
            det_db_thresh=0.1,           # Très bas pour capter le texte pâle ($7.07)
            det_db_box_thresh=0.3,       # Accepte des boîtes moins "sûres"
            det_db_unclip_ratio=2.5,     # TRES IMPORTANT : Élargit les boîtes pour fusionner "SALE AMOUNT" et le prix
            # use_space_char=True,
            # show_log=False
        )
